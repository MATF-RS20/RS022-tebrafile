...
QT_MOC_LITERAL(1, 12, 19), // "credentialsCaptured"
QT_MOC_LITERAL(2, 32, 0), // ""
QT_MOC_LITERAL(3, 33, 12), // "InputDialog*"
QT_MOC_LITERAL(4, 46, 4), // "diag"
QT_MOC_LITERAL(5, 51, 10) // "ok_clicked"

    },
    "InputDialog\0credentialsCaptured\0\0"
    "InputDialog*\0diag\0ok_clicked"
};
...
void InputDialog::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->credentialsCaptured((*reinterpret_cast< InputDialog*(*)>(_a[1]))); break;
        ...
        {
            typedef void (InputDialog::*_t)(InputDialog * );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&InputDialog::credentialsCaptured)) {
                *result = 0;
                return;
            }
        }
...
// SIGNAL 0
void InputDialog::credentialsCaptured(InputDialog * _t1)
{
